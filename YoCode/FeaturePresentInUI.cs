...
namespace YoCode
{
    internal class FeaturePresentInUI
    {
        private readonly IWebDriver browser;
        private readonly string[] keyWords;

        public FeaturePresentInUI(IWebDriver browser, string[] keyWords)
        {
            FeatureInUIEvidence.FeatureTitle = "Found feature evidence in user interface";
        ...
        private void ExecuteCheck()
        {
            foreach (HtmlTags tag in Enum.GetValues(typeof(HtmlTags)))
            {
                ...
                {
                    FeatureInUIEvidence.FeatureImplemented = true;
                    FeatureInUIEvidence.GiveEvidence("Found new feature in user interface");
                    return;
                }
            }
            FeatureInUIEvidence.FeatureImplemented = false;
            FeatureInUIEvidence.GiveEvidence("Could not find new feature in user interface");
        }
        ...
        //public FeaturePresentInUI(IWebDriver browser)
        //{
        ...
        public FeatureEvidence FeatureInUIEvidence { get; } = new FeatureEvidence();
    }
}